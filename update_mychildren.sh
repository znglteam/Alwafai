cat << 'INNEREOF' > temp_mychildren_new.tsx
            {/* List of My Children */}
...
# Note: we need to also replace the closing </div> of <div className="space-y-3"> with </Reorder.Group>
# Let's see the lines after 497
